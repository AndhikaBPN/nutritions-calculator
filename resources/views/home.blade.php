            ...
            <div class="flex gap-4 flex-1">
                ...
                <div class="flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    @elseif ($log && $log->status === \App\Enums\MealLogStatus::Pending)
                        ...
                        <p class="text-xs text-gray-400 leading-relaxed">Sedang dianalisis oleh AI...</p>
                    ...
                    @else
                        <p class="font-medium text-gray-700 text-sm mb-1">Detail nutrisi</p>
                        <p class="text-xs text-gray-400 leading-relaxed">Upload foto makanan agar detail nutrisi tampil otomatis.</p>
                    @endif
                </div>
            </div>
        </div>
