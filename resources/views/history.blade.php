...
@if ($logs->isEmpty())
    <div class="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
        ...
        <p class="text-gray-400 text-sm mt-1">Upload foto makanan di halaman Home untuk mulai mencatat.</p>
            ...
            <div class="rounded-2xl border p-5 {{ $bgClass }} transition-shadow hover:shadow-md">
                <div class="flex gap-4">
                    ...
                    <div class="shrink-0">
                        ...
                        @else
                            <div class="w-24 h-24 rounded-xl bg-white/50 flex items-center justify-center text-2xl text-gray-300">
                                🍽️
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="flex flex-wrap items-start justify-between gap-2">
                            <div>
                                @if ($log->status === \App\Enums\MealLogStatus::Pending)
                                    <p class="font-bold text-gray-700">Menganalisis...</p>
